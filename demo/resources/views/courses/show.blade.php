            ...
            <div class="lg:col-span-8 space-y-10">
                <div>
                    ...
                    <div class="mb-10 rounded-[24px] overflow-hidden shadow-2xl border-4 border-white bg-black aspect-video relative group/trailer">
                        <iframe src="https://www.youtube.com/embed/{{ $videoId }}?controls=1&modestbranding=1&rel=0" class="w-full h-full" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
